...
*Extension/Challenge: How would you visualize the relationship between the outcome and longitude and latitude, respectively?*
...
in [`slides/setup.R`](https://github.com/hfrick/tidymodels-survival-workshop/blob/main/slides/setup.R).
