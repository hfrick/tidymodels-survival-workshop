...
-   Type `?cat_adoption` or check the [sources](https://github.com/tidymodels/modeldata/blob/main/data-raw/cat_adoption.R#L10) to learn more about this dataset, including references.
:::
