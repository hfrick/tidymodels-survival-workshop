...
In regards to the weird formula assembly: this is a lot easier if we use a [recipe](https://workshops.tidymodels.org/slides/advanced-02-feature-engineering.html). 
